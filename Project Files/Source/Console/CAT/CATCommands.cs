...
//				return AddLeadingZeros((int) console.RX1FilterLow);
		...
		public string ZZFM()
		{
            ...
            else if (radio == "ANAN100" || radio == "ANAN100B" || radio == "ANAN100D" || radio == "ANAN200D" || radio == "ANAN7000D" || radio == "ANAN8000D" || radio == "ANVELINAPRO3" || radio == "REDPITAYA" || radio == "ANAN_G2" || radio == "ANAN_G2_1K")  // DH1KLM_21a added 7000D
                return "1";
            else
                return parser.Error1;
...
//		}
        ...
        public string ZZRV()
        {
            ...
            if (console.CurrentHPSDRModel == HPSDRModel.ANAN7000D || console.CurrentHPSDRModel == HPSDRModel.ANAN8000D ||
                   console.CurrentHPSDRModel == HPSDRModel.ANVELINAPRO3 || console.CurrentHPSDRModel == HPSDRModel.REDPITAYA ||
